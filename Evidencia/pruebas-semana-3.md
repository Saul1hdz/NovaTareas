...
El mapa inicial se amplió hasta **88 pruebas** para cubrir el contrato y los
...
| `tests/sqliteToPostgres.test.js` | 4 | Transformación de fechas, booleanos, tokens y embeddings para PostgreSQL |
...
npm test      # ejecuta las 88 pruebas
npm run lint          # verificar tipos y sintaxis del proyecto
```

Resultado esperado: 88 pruebas superadas, sin conexión a servicios externos ni
credenciales reales.
